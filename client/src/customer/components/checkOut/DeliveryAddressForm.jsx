                    ...
                    <Box className="border rounded-md shadow-md p-5">
                        <form onSubmit={handleSubmit}>
                            ...
                            <Grid container spacing={3} mt={2}>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <TextField required id='phoneNumber' name='phoneNumber' label="Phone Number" fullWidth autoComplete='number' />
                                </Grid>
                            </Grid>
                            <Grid item xs={12} sm={6} className="text-left">
                                <Button sx={{ py: 2, mt: 2, bgcolor: 'RGB( 145 85 253)' }} size='large' variant='contained' type='submit'>Deliver Here</Button>
                            </Grid>
                        </form>
                    </Box>
                </Grid>
