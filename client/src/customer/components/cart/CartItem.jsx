        ...
        <div className='p-5 shadow-lg border rounded-md'>
            <div className='flex items-center '>
                <div className='w-[5rem] h-[5rem] lg:w-[9rem] lg:h-[9rem]'>
                    <img className='w-full h-full object-cover object-top ' src='https://m.media-amazon.com/images/I/61u5oAftaeL._SY879_.jpg' alt='' />
                </div>
                <div className='ml-5 space-y-1 text-left'>
                    ...
                    <p className='opacity-70 mt-2'> Seller: Visit the Lymio Store </p>
