    ...
    return (
        <div className="bg-white lg:px-20">
            <div className="pt-6">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3780 Reviews </p>
                                </div>
                ...
                <section className='text-lg pb-4 text-left'>
                    <h1 className='font-semibold '> Recent Review & Rating</h1>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className='opacity-60'>5843232 Ratings</p>
                                </div>
